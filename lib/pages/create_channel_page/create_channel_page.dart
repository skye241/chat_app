...
class _CreateChannelPageState extends State<CreateChannelPage> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CreateChannelCubit, CreateChannelState>(
      bloc: cubit,
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) => Container(
                              ...
                              child: state.selectedUsers[index].image != null
                                  ? Image.network(
                                      state.selectedUsers[index].image!)
                                  : Center(
                                      child: Text(
                                      state.selectedUsers[index].name[0]
                                          .toUpperCase(),
                                      style: const TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
